...
/*
	...
	EM RELACIONAMENTO (1,1) A FK FICA NA ENTIDADE MAIS FRACA
	EM RELACIONAMENTO (1,n) A FK FICA NA CARDINALIDADE n
...
INSERT INTO CLIENTE VALUES( null,'João', 'M','joao@email','12345678901');
INSERT INTO CLIENTE VALUES( null,'Ana', 'F','ana@email','94184729184');
INSERT INTO CLIENTE VALUES( null,'Paul', 'M','paul@email','67542312346');
INSERT INTO CLIENTE VALUES( null,'Juca', 'M','juca@email','09418472849');
INSERT INTO CLIENTE VALUES( null,'Cris', 'F','cris@email','10293847563');
INSERT INTO CLIENTE VALUES( null,'Mario', 'M','mario@email','12321454316');
...
+------------+-------+------+-------------+-------------+
|          1 | João  | M    | joao@email  | 12345678901 |
|          2 | Ana   | F    | ana@email   | 94184729184 |
|          3 | Paul  | M    | paul@email  | 67542312346 |
|          4 | Juca  | M    | juca@email  | 09418472849 |
|          5 | Cris  | F    | cris@email  | 10293847563 |
|          6 | Mario | M    | mario@email | 12321454316 |
+------------+-------+------+-------------+-------------+

INSERT INTO ENDERECO VALUES( null,'Rua da amargura, 20','Centro', 'Porto Alegre', 'RS', 1);
INSERT INTO ENDERECO VALUES( null,'Rua da cebola, 45','Higienóplis', 'Rio de Janeiro', 'RJ', 2);
INSERT INTO ENDERECO VALUES( null,'Rua da bagunça, 123','Atalaia', 'Aracaju', 'SE', 3);
INSERT INTO ENDERECO VALUES( null,'Rua do tombo, 001','Azar', 'Camaquã', 'RS', 4);
INSERT INTO ENDERECO VALUES( null,'Rua da cachaça, 51','Bebados', 'Natal', 'RN', 5);
...
+-------------+---------------------+-------------+----------------+--------+------------+
|           1 | Rua da amargura, 20 | Centro      | Porto Alegre   | RS     |          1 |
|           2 | Rua da cebola, 45   | Higienóplis | Rio de Janeiro | RJ     |          2 |
|           3 | Rua da bagunça, 123 | Atalaia     | Aracaju        | SE     |          3 |
|           4 | Rua do tombo, 001   | Azar        | Camaquã        | RS     |          4 |
|           5 | Rua da cachaça, 51  | Bebados     | Natal          | RN     |          5 |
|           6 | Rua da mijo, 13     | Candelária  | Pontaporã      | MT     |          6 |
+-------------+---------------------+-------------+----------------+--------+------------+

DESC TELEFONE;

INSERT INTO TELEFONE VALUES(NULL, 'CEL','99831-0860', 1);
INSERT INTO TELEFONE VALUES(NULL, 'RES','3546-9876', 2);
INSERT INTO TELEFONE VALUES(NULL, 'COM','3267-3000', 2);
INSERT INTO TELEFONE VALUES(NULL, 'COM','3345-1313', 4);
INSERT INTO TELEFONE VALUES(NULL, 'CEL','99555-2456', 4);
INSERT INTO TELEFONE VALUES(NULL, 'RES','3322-4876', 6);
INSERT INTO TELEFONE VALUES(NULL, 'COM','3322-3451', 3);
INSERT INTO TELEFONE VALUES(NULL, 'CEL','98877-3567', 5);
...
PROJEÇÃO -> TUDO O QUE É VISTO NA TELA

SELECT TIPO FROM TELEFONE;
SELECT NOW() AS DATA_ATUAL;

SELEÇÃO -> FILTRO (SUB CONJUNTO DO CONJUNTO TOTAL)
...
+------+------+-------------+----------------+
| João | M    | Centro      | Porto Alegre   |
| Ana  | F    | Higienóplis | Rio de Janeiro |
| Paul | M    | Atalaia     | Aracaju        |
| Juca | M    | Azar        | Camaquã        |
| Cris | F    | Bebados     | Natal          |
+------+------+-------------+----------------+